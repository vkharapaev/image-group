...
import com.headmostlab.imagegroup.RoundedCornersImageLoader
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        with(binding) {
            ...
            imageGroupView.setImageLoader(
                RoundedCornersImageLoader(
                    resources.getDimensionPixelSize(R.dimen.image_view_group_image_radius).toFloat()
                )
            )
            ...
            imageGroupView2.setImageLoader(
                RoundedCornersImageLoader(
                    resources.getDimensionPixelSize(R.dimen.image_view_group_image_radius).toFloat()
                )
            )
